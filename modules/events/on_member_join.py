...
class OnMemberJoin(commands.Cog):
    ...
    async def on_member_join(self, member):
        ...
        embed = disnake.Embed(
            ...
            description=f"Привет, <@{member.id}>! Мы очень рады, что ты решил зайти на наш сервер. Ознакомься с правилами в канате <#1428120984011149424>, можешь начинать начинай общение. Удачи!",
            color=0x3aa33a
        )
